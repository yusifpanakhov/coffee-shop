    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {orders.map((o) => (
          <div
            key={o.id}
            className="bg-white shadow-xl p-6 rounded-2xl border border-[#EFE9E3] hover:shadow-2xl transition"
          >
            ...
            <button
              ...
              className="mt-3 w-full bg-[#006442] text-white py-2 rounded-xl hover:bg-[#004f34] transition"
            >
              Ready
            </button>
          </div>
